...
def memnet_m6r6(name, clean_data=None, noisy_data=None, num_filters=64, image_c=1, is_training=False, reuse=False):
    ...
    with tf.variable_scope(name, reuse=reuse):
        ...
        if is_training:
            ...
            loss_01 = tf.reduce_mean(tf.losses.absolute_difference(HR_recovery_01, clean_data))
        ...
        if is_training:
            ...
            loss_02 = tf.reduce_mean(tf.losses.absolute_difference(HR_recovery_02, clean_data))
        # scale
        ...
        if is_training:
            ...
            loss_03 = tf.reduce_mean(tf.losses.absolute_difference(HR_recovery_03, clean_data))
        # scale
        ...
        if is_training:
            ...
            loss_04 = tf.reduce_mean(tf.losses.absolute_difference(HR_recovery_04, clean_data))
        # scale
        ...
        if is_training:
            ...
            loss_05 = tf.reduce_mean(tf.losses.absolute_difference(HR_recovery_05, clean_data))
        # scale
        ...
        if is_training:
            ...
            loss_06 = tf.reduce_mean(tf.losses.absolute_difference(HR_recovery_06, clean_data))
        # scale
        ...
        if is_training:
            ...
            loss_07 = tf.reduce_mean(tf.losses.absolute_difference(HR_recovery, clean_data))
